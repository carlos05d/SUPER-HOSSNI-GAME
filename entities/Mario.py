...
# Load housni.png image and scale it for small and big animations
housni_img = pygame.image.load("img/houssam.png")
housni_small = pygame.transform.scale(housni_img, (32, 32))
housni_big = pygame.transform.scale(housni_img, (32, 64))

smallAnimation = Animation(
    [housni_small, housni_small, housni_small],
    housni_small,
    housni_small,
)
bigAnimation = Animation(
    [housni_big, housni_big, housni_big],
    housni_big,
    housni_big,
)
